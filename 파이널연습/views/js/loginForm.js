...
if (findIdButton) {
    ...
    findIdButton.addEventListener('click', function() {
        ...
        window.location.href = 'file:///C:/workspace/%ED%8C%8C%EC%9D%B4%EB%84%90%EC%97%B0%EC%8A%B5/views/jsp/findIdForm.html';
    });
} else {
    ...
    if (findPwdButton) {
        ...
        findPwdButton.addEventListener('click', function() {
            ...
            window.location.href = 'file:///C:/workspace/%ED%8C%8C%EC%9D%B4%EB%84%90%EC%97%B0%EC%8A%B5/views/jsp/findPwdForm.html';
        });
    } else {
    ...
    if (signinButton) {
        ...
        signinButton.addEventListener('click', function() {
            ...
            window.location.href = 'file:///C:/workspace/%ED%8C%8C%EC%9D%B4%EB%84%90%EC%97%B0%EC%8A%B5/views/jsp/insertForm.html';
        });
    } else {
